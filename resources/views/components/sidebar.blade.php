    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
            <div class="profile-info">
                ...
                <div class="user-info">
                    <img src="{{auth()->user()->photo ?? asset('assets/img/profile-17.jpg')}}" alt="avatar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                @endif
                <li class="menu">
                    <a href="{{ route('customers')}} " aria-expanded="{{Request::is('customer*') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
...
{{--
                ...
                <li class="menu">
                    <a href="{{ route('parts')}} " aria-expanded="{{Request::is('parts*') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="{{ route('part-types')}} " aria-expanded="{{Request::is('part-types*') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="{{ route('showUsersActivity')}} " aria-expanded="{{Request::is('activity') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="{{ route('showMyActivity')}} " aria-expanded="{{Request::is('myActivity') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                ...
                <li class="menu">
                    <a href="{{ route('ammendments')}} " aria-expanded="{{Request::is('ammendments') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                ...
                <li class="menu">
                    <a href="{{ route('report')}} " aria-expanded="{{Request::is('report') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                            <span>Report</span>
                        </div>
